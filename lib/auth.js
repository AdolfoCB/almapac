  ...
  providers: [
    CredentialsProvider({
      ...
      async authorize(credentials, req) {
        ...
        // 🔍 Buscar usuario con relación de rol incluida
        ...
        console.log(`✅ [authorize] Login OK: ${username} (Rol: ${roleName})`);
    ...
    async jwt({ token, user, req }) {
      if (user) {
        ...
        try {
          ...
          console.log('🎫 ========================================');
          console.log(`✅ [JWT] Token NextAuth y sesión generados para ${user.username}`);
